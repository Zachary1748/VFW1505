...
//@interface Gover_Zachary_Project3Object : NSObject
//@end

@interface Gover_Zachary_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Gover_Zachary_Project3Object class]])
		{
			for (NSString *key in [[(Gover_Zachary_Project3Object*)o modules] allKeys])
			{
