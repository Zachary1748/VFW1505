...
@interface Gover_Zachary_Project3Object : KrollCoverageObject {
#else
@interface Gover_Zachary_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Gover_Zachary_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Gover_Zachary_Project3Object *_gover_zachary_project3;
    KrollObject* console;
	BOOL shutdown;
