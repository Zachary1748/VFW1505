...
// in simulator we redefine to format for Gover_Zachary_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.gover_zachary_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gover_zachary_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGover_Zachary_Project3NativeItemNone = -1, 
	UIGover_Zachary_Project3NativeItemSpinner = -2,
	UIGover_Zachary_Project3NativeItemProgressBar = -3,
	
	UIGover_Zachary_Project3NativeItemSlider = -4,
	UIGover_Zachary_Project3NativeItemSwitch = -5,
	UIGover_Zachary_Project3NativeItemMultiButton = -6,
	UIGover_Zachary_Project3NativeItemSegmented = -7,
	
	UIGover_Zachary_Project3NativeItemTextView = -8,
	UIGover_Zachary_Project3NativeItemTextField = -9,
	UIGover_Zachary_Project3NativeItemSearchBar = -10,
	
	UIGover_Zachary_Project3NativeItemPicker = -11,
	UIGover_Zachary_Project3NativeItemDatePicker = -12,
	
	UIGover_Zachary_Project3NativeItemInfoLight = -13,
	UIGover_Zachary_Project3NativeItemInfoDark = -14,
	
	UIGover_Zachary_Project3NativeItemDisclosure = -15,
	
	UIGover_Zachary_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Gover_Zachary_Project3 instances of
