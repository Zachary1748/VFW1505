...
// in simulator we redefine to format for Gover_Zachary_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.gover_zachary_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gover_zachary_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGover_Zachary_Project1NativeItemNone = -1, 
	UIGover_Zachary_Project1NativeItemSpinner = -2,
	UIGover_Zachary_Project1NativeItemProgressBar = -3,
	
	UIGover_Zachary_Project1NativeItemSlider = -4,
	UIGover_Zachary_Project1NativeItemSwitch = -5,
	UIGover_Zachary_Project1NativeItemMultiButton = -6,
	UIGover_Zachary_Project1NativeItemSegmented = -7,
	
	UIGover_Zachary_Project1NativeItemTextView = -8,
	UIGover_Zachary_Project1NativeItemTextField = -9,
	UIGover_Zachary_Project1NativeItemSearchBar = -10,
	
	UIGover_Zachary_Project1NativeItemPicker = -11,
	UIGover_Zachary_Project1NativeItemDatePicker = -12,
	
	UIGover_Zachary_Project1NativeItemInfoLight = -13,
	UIGover_Zachary_Project1NativeItemInfoDark = -14,
	
	UIGover_Zachary_Project1NativeItemDisclosure = -15,
	
	UIGover_Zachary_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Gover_Zachary_Project1 instances of
