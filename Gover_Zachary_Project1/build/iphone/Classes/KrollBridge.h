...
@interface Gover_Zachary_Project1Object : KrollCoverageObject {
#else
@interface Gover_Zachary_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Gover_Zachary_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Gover_Zachary_Project1Object *_gover_zachary_project1;
    KrollObject* console;
	BOOL shutdown;
