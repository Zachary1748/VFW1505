...
// in simulator we redefine to format for Gover_Zachary_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.gover_zachary_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gover_zachary_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGover_Zachary_Project2NativeItemNone = -1, 
	UIGover_Zachary_Project2NativeItemSpinner = -2,
	UIGover_Zachary_Project2NativeItemProgressBar = -3,
	
	UIGover_Zachary_Project2NativeItemSlider = -4,
	UIGover_Zachary_Project2NativeItemSwitch = -5,
	UIGover_Zachary_Project2NativeItemMultiButton = -6,
	UIGover_Zachary_Project2NativeItemSegmented = -7,
	
	UIGover_Zachary_Project2NativeItemTextView = -8,
	UIGover_Zachary_Project2NativeItemTextField = -9,
	UIGover_Zachary_Project2NativeItemSearchBar = -10,
	
	UIGover_Zachary_Project2NativeItemPicker = -11,
	UIGover_Zachary_Project2NativeItemDatePicker = -12,
	
	UIGover_Zachary_Project2NativeItemInfoLight = -13,
	UIGover_Zachary_Project2NativeItemInfoDark = -14,
	
	UIGover_Zachary_Project2NativeItemDisclosure = -15,
	
	UIGover_Zachary_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Gover_Zachary_Project2 instances of
