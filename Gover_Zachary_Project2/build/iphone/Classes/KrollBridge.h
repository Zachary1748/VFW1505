...
@interface Gover_Zachary_Project2Object : KrollCoverageObject {
#else
@interface Gover_Zachary_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Gover_Zachary_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Gover_Zachary_Project2Object *_gover_zachary_project2;
    KrollObject* console;
	BOOL shutdown;
