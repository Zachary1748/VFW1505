...
//Rare exceptions to indicate a bug in the _gover_zachary_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Gover_Zachary_Project2 proxies.
 */
