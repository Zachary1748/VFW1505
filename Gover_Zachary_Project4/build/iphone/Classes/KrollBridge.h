...
@interface Gover_Zachary_Project4Object : KrollCoverageObject {
#else
@interface Gover_Zachary_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Gover_Zachary_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Gover_Zachary_Project4Object *_gover_zachary_project4;
    KrollObject* console;
	BOOL shutdown;
