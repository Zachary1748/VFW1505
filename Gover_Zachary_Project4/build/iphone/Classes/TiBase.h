...
// in simulator we redefine to format for Gover_Zachary_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.gover_zachary_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gover_zachary_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGover_Zachary_Project4NativeItemNone = -1, 
	UIGover_Zachary_Project4NativeItemSpinner = -2,
	UIGover_Zachary_Project4NativeItemProgressBar = -3,
	
	UIGover_Zachary_Project4NativeItemSlider = -4,
	UIGover_Zachary_Project4NativeItemSwitch = -5,
	UIGover_Zachary_Project4NativeItemMultiButton = -6,
	UIGover_Zachary_Project4NativeItemSegmented = -7,
	
	UIGover_Zachary_Project4NativeItemTextView = -8,
	UIGover_Zachary_Project4NativeItemTextField = -9,
	UIGover_Zachary_Project4NativeItemSearchBar = -10,
	
	UIGover_Zachary_Project4NativeItemPicker = -11,
	UIGover_Zachary_Project4NativeItemDatePicker = -12,
	
	UIGover_Zachary_Project4NativeItemInfoLight = -13,
	UIGover_Zachary_Project4NativeItemInfoDark = -14,
	
	UIGover_Zachary_Project4NativeItemDisclosure = -15,
	
	UIGover_Zachary_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Gover_Zachary_Project4 instances of
