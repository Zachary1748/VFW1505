...
//@interface Gover_Zachary_Project4Object : NSObject
//@end

@interface Gover_Zachary_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Gover_Zachary_Project4Object class]])
		{
			for (NSString *key in [[(Gover_Zachary_Project4Object*)o modules] allKeys])
			{
